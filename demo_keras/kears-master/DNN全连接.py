...
y_train = keras.utils.to_categorical(a/1.5, num_classes=10)  # one-hot编码，1000个样本，10种分类

x_test = np.random.random((100, 20))    # 产生随机数，100个样本，20个属性
y_test = keras.utils.to_categorical(x_test.sum(axis=1)/1.5, num_classes=10)   # one-hot编码，100个样本，10种分类
